...
import com.autobots.automanager.modelo.Link.AdicionarLinkUsuario;
import com.autobots.automanager.modelo.Seleciona.EmpresaSelecionador;
import com.autobots.automanager.modelo.Seleciona.UsuarioSelecionador;
import com.autobots.automanager.repositorios.EmpresaRepositorio;
import com.autobots.automanager.repositorios.UsuarioRepositorio;
import com.autobots.automanager.servico.EmpresaUsuario;
...
public class UsuarioControle {
	...
	public ResponseEntity<?> cadastrarUsuario(@RequestBody EmpresaUsuario novoUsuario) {
		HttpStatus status = HttpStatus.CONFLICT;
		List<Empresa> empresas = repositorioEmpresa.findAll();
		Empresa selecionada = selecionadorEmpresa.selecionar(empresas, novoUsuario.getId());

		if (selecionada != null) {
			selecionada.getUsuarios().add(novoUsuario.getUsuario());
